...
void interrupt ISR()
{
    ...
    if(CCP1IF)          //Y-Voltage ZCD
    {
        CCP1IF = 0;
        CCP1IE = 1;     // enable interrupt
        Freq_Flag = 1;
        R_V_Old = R_V_New;
        R_V_New = ((CCPR1H << 8) | CCPR1L);
    }
    ...
    if(CCP3IF)          //R-Current ZCD
    {
        ...
        Rcurr_V_Old = (R_V_Old - Phase_Shift_120);             
        Rcurr_V_New = (R_V_New - Phase_Shift_120);  
    }
    ...
    if(CCP5IF)          //B-Current ZCD
    {
        ...
        Bcurr_V_Old = (R_V_Old + Phase_Shift_120);             
        Bcurr_V_New = (R_V_New + Phase_Shift_120);  
    }
    ...
    {
        CCP10IF = 0;
        Wind_Cap_Old_2 = Wind_Cap_New_2;
        Wind_Cap_New_2 = (256*CCPR10H)+CCPR10L;      //Capture Time Stamp
        Timer1_OF_counter_Wind_2_temp_Old = Timer1_OF_counter_Wind_2_temp_New;
        Timer1_OF_counter_Wind_2_temp_New = Timer1_OF_counter_Wind_2_temp;
        Wind_Cap_2 = 1;
    }
    if(CCP6IF)
    {
