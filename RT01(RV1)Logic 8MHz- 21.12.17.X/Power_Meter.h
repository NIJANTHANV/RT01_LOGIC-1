...
#define KV_Constant (0.727749)//(0.89172) // 60Hz(0.727749)
#define KC_Constant (0.036912)
#define V_Shifted_Bits (2119)
#define C_Shifted_Bits (2119)
#define High_Volt (470)
#define Low_Volt (350)
#define High_Curr (12)

#define Phase_Shift_120 (1666.667)  // For 120degree ==> ((120*20)/360)=6.67ms, 65535/262.14ms = 250.13 ==> (6.67* 250.13) = 1666.667

#define SD_Phase_Shift (0.575959)   // SD Phase shift degree ==> ((360*1.83ms))/20)) = 33degree = 0.575959 in radian
