...
void PM_IO_Initialization(void) 
{
    ...
    ///////////////// Frequency (Y-Voltage ZCD) /////////////////
    
    TRISCbits.TRISC2 = 1;           // ECCP1(RC2) for set as input
    ...
    ///////////////// Power Factor (R,Y,B-Current ZCD) /////////////////
...
//    ///////////////// Relay control for PF Correction /////////////////
//    
//    TRISFbits.TRISF1 = 0;      // RF1 for Capacitor-1 set as Output
//    TRISFbits.TRISF2 = 0;      // RF2 for Capacitor-2 set as Output
//    TRISFbits.TRISF3 = 0;      // RF3 for Capacitor-3 set as Output
//    
//    RF1 = 0;        // RF1 Set as Initial Zero
//    RF2 = 0;        // RF2 Set as Initial Zero
//    RF3 = 0;        // RF3 Set as Initial Zero
//    
//    //////////////////////////////////////////////////////////////////
...
void Temp_Read(void)
{
    ...
    Temprature = (Temp_Sensor * 0.118925);      // For mV we multiply 1000,10mV = 1 degree so,we divide by 10,Totally we multiply with 100 
                                              // = ((4.87v / 4095)*100 = 0.0957)
...
void PM_Error_Led(void)
{
    if ((Phase_Sequence_Ok == 0) || (R_Volt <= UNDER_VOLTAGE_LIMIT) || (Y_Volt <= UNDER_VOLTAGE_LIMIT) || 
            ...
            (B_Curr >= GRID_OVER_CURRENT_LIMIT) || (Frequency <= 47.5) || (Frequency >=52.5) || (KW <= MINIMUM_KW) || 
            (KW >= MAXIMUM_KW ))
    {
        PM_Error_LED_ON;
    }
